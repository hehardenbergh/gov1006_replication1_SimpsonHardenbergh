...
```{r Table 1 Number of kids and daughters}
...
```{r Calculating the Weights (Number of Cases)}
...
```{r Table 3: Distribution of Cases}
...
```{r Table 5: Core Results (Case-Level)}
...
```{r Table 6: Comparison for Non-Gender Related Cases}
